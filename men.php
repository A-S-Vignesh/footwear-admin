	...
	<!-- Slidebar start -->
		<div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="men.php" class="list-group-item list-group-item-action bg-purple second-text active ">
                    ...
                    <table id="user-table" class="table table-bordered table-hover align-items-center text-center bg-light rounded shadow-sm table-hover">
                        ...
                        <tbody>
                            ...
                            <td> 
                                    ...
                                    <a href="MUpdate.php?id=<?php echo $row['product_code']; ?>" class="btn btn-md top-header">
                                        <i class="fa-solid fa-pen-to-square" style="color: #0be524;"></i></a>
                            </td>
                            <td>
                                    <a href="dusers.php" class="btn btn-md top-header"> 
                                        <i class="fa-solid fa-trash" style="color: #f00505;"></i> </a>
                            </td>
                            </tr>
                            <?php
                            }
